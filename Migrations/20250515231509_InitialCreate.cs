        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForwardOfId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Emails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Emails_Emails_ForwardOfId",
                        column: x => x.ForwardOfId,
                        principalTable: "Emails",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Emails_Emails_ReplyToId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Emails_ForwardOfId",
                table: "Emails",
                column: "ForwardOfId");

            migrationBuilder.CreateIndex(
                name: "IX_Emails_ReplyToId",
                table: "Emails",
                column: "ReplyToId");
        }
